...
public class SelectorsCss {
    ...
    public void phoneBookTest(){
        ...
        //driver.get("http:telranedu.web.app/home");
        driver.navigate().to("http://telranedu.web.app/home");
        pause(3);
    ...
    public void ilCarroTest(){
        ...
        WebElement btnLetCarWork = driver.findElement(By.className("navigation-link"));
        btnSearch.click();
        pause(3);
